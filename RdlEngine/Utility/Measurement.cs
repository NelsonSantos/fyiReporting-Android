...
namespace fyiReporting.RDL.Utility
{
    ...
    public sealed class Measurement
    {
        ...
        /// A method used to convert points into pixels.
        /// </summary>
        /// <returns>A Android.Graphics.PointF containing the pixel X and Y values for the point X and Y values that were supplied.</returns>
        public static Android.Graphics.PointF PixelsFromPoints(float pointsX, float pointsY, Android.Graphics.PointF Dpi)
        {
            return new Android.Graphics.PointF(PixelsFromPoints(pointsX, Dpi.X), PixelsFromPoints(pointsY, Dpi.Y));
        }
        /// <summary>
