...
//            get {
//                return IsHeadless ? 96 : 96; //					awt.Toolkit.getDefaultToolkit().getScreenResolution();
//            }
//        }
...
////        #region DrawBezier(s)
////        public void DrawBezier (Pen pen, Android.Graphics.PointF pt1, Android.Graphics.PointF pt2, Android.Graphics.PointF pt3, Android.Graphics.PointF pt4) {
...
////        public void DrawBeziers (Pen pen, Android.Graphics.PointF [] points) {
////            GraphicsPath path = new GraphicsPath();
////            path.AddBeziers(points);
////            DrawPath(pen, path);
////        }
...
////        public void DrawClosedCurve (Pen pen, Android.Graphics.PointF [] points) {
...
////        public void DrawClosedCurve (Pen pen, Android.Graphics.PointF [] points, float tension, FillMode fillmode) {
////            GraphicsPath path = new GraphicsPath(fillmode);
////            path.AddClosedCurve(points, tension);
////            DrawPath(pen, path);
////        }
...
////        public void DrawCurve (Pen pen, Android.Graphics.PointF [] points) {
////            DrawCurve(pen, points, 0.5f);
////        }
		
////        public void DrawCurve (Pen pen, Android.Graphics.PointF [] points, float tension) {
...
////        public void DrawCurve (Pen pen, Android.Graphics.PointF [] points, int offset, int numberOfSegments) {
...
////        public void DrawCurve (Pen pen, Android.Graphics.PointF [] points, int offset, int numberOfSegments, float tension) {
////            GraphicsPath path = new GraphicsPath();
////            path.AddCurve(points, offset, numberOfSegments, tension);
////            DrawPath(pen, path);
////        }
...
////        public void DrawImage (Image image, Android.Graphics.PointF point) {
////            DrawImage(image, point.X, point.Y);
////        }
...
////        public void DrawImage (Image image, Android.Graphics.PointF [] destPoints) {
...
////                                 new Android.Graphics.PointF( destRect.X, destRect.Y),
////                                 new Android.Graphics.PointF( destRect.X + destRect.Width, destRect.Y),
////                                 new Android.Graphics.PointF( destRect.X, destRect.Y + destRect.Height)},
////                srcRect, 
////                srcUnit);
////        }
...
////        public void DrawImage (Image image, Android.Graphics.PointF [] destPoints, RectangleF srcRect, GraphicsUnit srcUnit) {
////            DrawImage(image, destPoints, srcRect, srcUnit, null);
////        }
...
////        [MonoLimitation ("ImageAttributes parameter is ignored.")]
////        public void DrawImage (Image image, Android.Graphics.PointF [] destPoints, RectangleF srcRect, GraphicsUnit srcUnit, ImageAttributes imageAttr) {
////            //TBD: ImageAttributes
////            if (srcUnit != GraphicsUnit.Pixel)
////                throw new NotImplementedException();
////            // Like in .NET http://dotnet247.com/247reference/msgs/45/227979.aspx
...
////        [MonoNotSupported ("")]
////        public void DrawImage (Image image, Android.Graphics.PointF [] destPoints, RectangleF srcRect, GraphicsUnit srcUnit, ImageAttributes imageAttr, DrawImageAbort callback)
////        {
////            throw new NotImplementedException ();
////        }
...
////        [MonoNotSupported ("")]
////        public void DrawImage (Image image, Android.Graphics.PointF [] destPoints, RectangleF srcRect, GraphicsUnit srcUnit, ImageAttributes imageAttr, DrawImageAbort callback, int callbackData)
////        {
////            throw new NotImplementedException ();
////        }
...
////            Android.Graphics.PointF [] p = new Android.Graphics.PointF[] { 
////                                           new Android.Graphics.PointF( 0, 0 ),
////                                           new Android.Graphics.PointF( img.Width, 0 ),
////                                           new Android.Graphics.PointF( 0, img.Height )};
...
////            Android.Graphics.PointF [] p = new Android.Graphics.PointF[] { 
////                                           new Android.Graphics.PointF( rect.X, rect.Y ),
////                                           new Android.Graphics.PointF( rect.X + rect.Width, rect.Y ),
////                                           new Android.Graphics.PointF( rect.X, rect.Y + rect.Height )};
...
////        #region DrawLine
////        public void DrawLine (Pen pen, Android.Graphics.PointF pt1, Android.Graphics.PointF pt2) {
...
////        public void DrawLines (Pen pen, Android.Graphics.PointF [] points) {
////            GraphicsPath path = new GraphicsPath();
...
////        public void DrawPolygon (Pen pen, Android.Graphics.PointF [] points) {
////            GraphicsPath path = new GraphicsPath();
////            path.AddPolygon(points);
////            DrawPath(pen, path);
////        }
...
////        public void DrawString (string s, Font font, Brush brush, Android.Graphics.PointF point) {
////            DrawString(s, font, brush, point.X, point.Y, float.PositiveInfinity, float.PositiveInfinity, null);
////        }
		
////        public void DrawString (string s, Font font, Brush brush, Android.Graphics.PointF point, StringFormat format) {
...
////            Matrix containerTransfrom =
////                new Matrix(	srcrect,
////                new Android.Graphics.PointF [] {	 new Android.Graphics.PointF (dstrect.X, dstrect.Y), 
////                                 new Android.Graphics.PointF (dstrect.X + dstrect.Width, dstrect.Y), 
////                                 new Android.Graphics.PointF (dstrect.X, dstrect.Y + dstrect.Height) });
...
////        [MonoTODO]
////        public void EnumerateMetafile (Metafile metafile, Android.Graphics.PointF [] destPoints, EnumerateMetafileProc callback)
////        {
////            throw new NotImplementedException ();
////        }
...
////        [MonoTODO]
////        public void EnumerateMetafile (Metafile metafile, Android.Graphics.PointF destPoint, EnumerateMetafileProc callback)
////        {
////            throw new NotImplementedException ();
////        }

////        [MonoTODO]
////        public void EnumerateMetafile (Metafile metafile, Android.Graphics.PointF destPoint, EnumerateMetafileProc callback, IntPtr callbackData)
////        {
////            throw new NotImplementedException ();
////        }
...
////        [MonoTODO]
////        public void EnumerateMetafile (Metafile metafile, Android.Graphics.PointF [] destPoints, EnumerateMetafileProc callback, IntPtr callbackData)
////        {
////            throw new NotImplementedException ();
////        }
...
////        [MonoTODO]
////        public void EnumerateMetafile (Metafile metafile, Android.Graphics.PointF destPoint, RectangleF srcRect, GraphicsUnit srcUnit, EnumerateMetafileProc callback)
////        {
////            throw new NotImplementedException ();
////        }
...
////        [MonoTODO]
////        public void EnumerateMetafile (Metafile metafile, Android.Graphics.PointF [] destPoints, RectangleF srcRect, GraphicsUnit srcUnit, EnumerateMetafileProc callback)
////        {
////            throw new NotImplementedException ();
////        }
...
////        [MonoTODO]
////        public void EnumerateMetafile (Metafile metafile, Android.Graphics.PointF destPoint, EnumerateMetafileProc callback, IntPtr callbackData, ImageAttributes imageAttr)
////        {
////            throw new NotImplementedException ();
////        }
...
////        [MonoTODO]
////        public void EnumerateMetafile (Metafile metafile, Android.Graphics.PointF [] destPoints, EnumerateMetafileProc callback, IntPtr callbackData, ImageAttributes imageAttr)
////        {
////            throw new NotImplementedException ();
////        }
...
////        [MonoTODO]
////        public void EnumerateMetafile (Metafile metafile, Android.Graphics.PointF [] destPoints, RectangleF srcRect, GraphicsUnit srcUnit, EnumerateMetafileProc callback, IntPtr callbackData)
////        {
////            throw new NotImplementedException ();
////        }
...
////        [MonoTODO]
////        public void EnumerateMetafile (Metafile metafile, Android.Graphics.PointF destPoint, RectangleF srcRect, GraphicsUnit srcUnit, EnumerateMetafileProc callback, IntPtr callbackData)
////        {
////            throw new NotImplementedException ();
////        }
...
////        [MonoTODO]
////        public void EnumerateMetafile (Metafile metafile, Android.Graphics.PointF [] destPoints, RectangleF srcRect, GraphicsUnit unit, EnumerateMetafileProc callback, IntPtr callbackData, ImageAttributes imageAttr)
////        {
////            throw new NotImplementedException ();
////        }

////        [MonoTODO]
////        public void EnumerateMetafile (Metafile metafile, Android.Graphics.PointF destPoint, RectangleF srcRect, GraphicsUnit unit, EnumerateMetafileProc callback, IntPtr callbackData, ImageAttributes imageAttr)
////        {
////            throw new NotImplementedException ();
////        }
////#endif 	
...
////        public void FillClosedCurve (Brush brush, Android.Graphics.PointF [] points) {
...
////        public void FillClosedCurve (Brush brush, Android.Graphics.PointF [] points, FillMode fillmode) {
...
////        public void FillClosedCurve (Brush brush, Android.Graphics.PointF [] points, FillMode fillmode, float tension) {
////            GraphicsPath path = new GraphicsPath(fillmode);
////            path.AddClosedCurve(points, tension);
////            FillPath(brush, path);
////        }
...
////        #region FillPolygon
////        public void FillPolygon (Brush brush, Android.Graphics.PointF [] points) {
...
////        public void FillPolygon (Brush brush, Android.Graphics.PointF [] points, FillMode fillMode) {
////            GraphicsPath path = new GraphicsPath(fillMode);
////            path.AddPolygon(points);
////            FillPath(brush,path);
////        }
...
//        //public bool IsVisible (Android.Graphics.PointF point) {
//        //    return IsVisible(point.X,point.Y);
//        //}
...
//        //public SizeF MeasureString (string text, Font font, Android.Graphics.PointF origin, StringFormat format) {
...
//        //[MonoTODO]
//        //public void TransformPoints (CoordinateSpace destSpace, CoordinateSpace srcSpace, Android.Graphics.PointF [] pts) {
//        //    //TBD:CoordinateSpace
