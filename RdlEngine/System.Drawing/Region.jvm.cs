...
{
    [ComVisible(false)]
    public sealed class Region : Android.Graphics.RectF
    {
        #region Member Vars
        ...
        #region Internals
        internal Android.Graphics.Region NativeObject
        {
            get
            {
                var _shape = new Android.Graphics.Region();
                return _shape;
            }
        }
        #endregion
        ...
        public Region()
            //: this(InfiniteRegion.NativeObject.Clone())
        {
        }

        internal Region(Android.Graphics.Rect native)
            : base(native)
        {
        }
        ...
        //    : this(new geom.Area(path.NativeObject))
        //{
        //}

        //public Region(Rectangle rect)
        //    : this(new geom.Area(rect.NativeObject))
        //{
        //}
        ...
        {
            return new RectangleF(this.Top, this.Left, this.Width(), this.Height());
        }
        #endregion
        ...
        //public bool IsVisible(Android.Graphics.PointF point, Graphics g)
        //{
        //    return IsVisible(point.X, point.Y, g);
        //}
