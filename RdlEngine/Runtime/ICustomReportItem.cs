...
namespace fyiReporting.RDL
{
	...
	public interface ICustomReportItem : IDisposable    
	{
        ...
        void DrawImage(ref Bitmap bm);       // Draw the image in the passed bitmap; do SetParameters first
        void DrawDesignerImage(ref Bitmap bm);   // Design time: Draw the designer image in the passed bitmap;
