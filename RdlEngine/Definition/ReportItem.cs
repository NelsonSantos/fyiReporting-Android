...
namespace fyiReporting.RDL
{
	...
	internal class ReportItem : ReportLink, IComparable
	{
		...
		class WorkClass
		{
		    private MatrixCellEntry m_Mc;	// matrix cell entry
		    private float m_BottomPosition;	// used when calculating position of objects below this one.
		    ...
		    {
		        get { return m_BottomPosition; }
		        set { m_BottomPosition = value; }
		    }
		}
