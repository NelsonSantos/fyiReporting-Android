...
namespace iTextSharp.text.pdf {
    ...
    public class PdfContentByte {
        ...
        */
        ...
        {
            SetRGBColorFillF(red, green, blue, 255f);
        }

        public virtual void SetRGBColorFillF(float red, float green, float blue, float alpha) 
        {
            SaveColor(new BaseColor(red, green, blue, alpha), true);
        ...
        */
        ...
        {
            SetRGBColorFill(red, green, blue, 255);
        }

        public virtual void SetRGBColorFill(int red, int green, int blue, int alpha)
        {
            SaveColor(new BaseColor(red, green, blue, alpha), true);
