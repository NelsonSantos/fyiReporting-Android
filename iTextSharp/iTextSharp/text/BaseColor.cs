...
namespace iTextSharp.text {
    /// <summary>
    /// Base class for Color, serves as wrapper class for <see cref="T:Android.Graphics.Color"/>
    /// to allow extension.
    /// </summary>
...
#if DRAWING
        /**
         * Construct a BaseColor by Android.Graphics.Color.
         * @param color
         */
        public BaseColor(Android.Graphics.Color color) :
